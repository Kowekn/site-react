  ...
  return (
    ...
    <div className="flex flex-col bg-[color:var(--sds-color-background-default-default)] text-base bg-neutral-900">
     ...
     {/*<img
      ...
      />*/}
      <div id="t" className="select-none saturate-100 relative justify-center place-content-center border-solid backdrop-blur-[3.46875px] border-[21px] border-black border-opacity-60 max-md:mt-10 max-md:max-w-full max-md:text-4xl">
        Visual ReportX
      </div>
    </div>
      <div className="flex flex-col p-16 mt-30 w-full bg-gradient-to-b from-neutral-950 to-neutral-800   max-md:px-5 max-md:mt-10 max-md:max-w-full min-h-[500px] pt-[100px] pb-[300px]">
        <div id="h" className="select-none pl-2 text-2xl font-semibold tracking-tight leading-7 text-[color:var(--sds-color-text-default-default)] max-md:max-w-full text-left">
          Home
        </div>
        {/* main body */}
                ...
                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                  ...
                  <div className="flex flex-col ml-5 w-[68%] max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col self-stretch max-md:mt-10">
                     ...
                     <Link to="/download"> <div id="h" className="active:text-neutral-400 hover:text-stone-50 text-2xl font-semibold tracking-tight leading-7 text-[color:var(--sds-color-text-default-default)] text-start ">
                        Download
                      </div></Link>
                ...
                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                  ...
                  <div className="flex flex-col w-[37%] max-md:ml-0 max-md:w-full bg-neutral-850">
                    <Link tabindex="-1" to="/registro"><BrasilEscuro
                      ...
                      className="size-48 max-w-full border-2 border-solid aspect-square border-stone-900 border-opacity-60 max-md:mt-10"
                    ></BrasilEscuro></Link>
                  </div>
                  ...
                  <div className="flex flex-col ml-5 w-[63%] max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col self-stretch max-md:mt-10">
                      ...
                      <Link to="/registro"><div id="h" className="active:text-neutral-400 hover:text-stone-50 text-2xl font-semibold tracking-tight leading-7 text-[color:var(--sds-color-text-default-default)] text-start ">
                        Registro
                      </div></Link>
